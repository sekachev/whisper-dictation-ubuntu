...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', '-m',
                        type=str,
                        default='turbo',
                        help='Whisper model to use. Defaults to "turbo".')
    parser.add_argument('--trt_model_path', '-trt',
                        type=str,
                        default=None,
                        help='Whisper TensorRT model path')
    parser.add_argument('--trt_multilingual', '-trt-m',
                        action="store_true",
    ...
    parser.add_argument('--max_connection_time',
                        type=int,
                        default=3600,
                        help='The maximum duration (in seconds) a client can stay connected. Defaults to 3600 seconds (1 hour)')
    ...
    server.run(
        ...
        faster_whisper_custom_model_path=args.faster_whisper_custom_model_path or args.model,
